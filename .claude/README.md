...
本项目的 `.claude/` 目录还包含 AI 自治记忆系统：

### 核心文件

| 文件 | 用途 |
|------|------|
| `ANCHORS.md` | 技能锚点索引 - 快速定位模块 |
| `MEMORY.md` | 增量记忆日志 - 最新变更记录 |
| `PROJECT_LOG.md` | 项目构建历史 - 完整决策记录 |
| `PROJECT_KICKOFF.md` | 项目启动清单 |
| `TASK_PLAN.md` | 任务执行计划 |
| `PROJECT_PROPOSAL.md` | 完整项目计划书 |

### AI 启动流程

```
1. ANCHORS.md          → 快速定位模块
2. PROJECT_LOG.md      → 理解完整历史
3. MEMORY.md           → 查看最新变更
4. CLAUDE.md           → 加载核心知识
5. prompts/            → 查看教程
6. rag/skill-index.json → RAG 技能索引
```
